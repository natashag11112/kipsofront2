                ...
                <Swiper getSwiper={setSwiper}>
                    <div className="banner-one__slide banner-one__slide-one">
                        <div className="container">
                            ...
                            <img src="/assets/images/slider-1-nat-1.png" className="banner-one__person" alt="" />
                            <div className="row no-gutters">
                                <div className="col-xl-12">
                                    <h3 className="banner-one__title banner-one__light-color">Welcome <br />
                                        To O<span style={{color:"#2da397"}}>X</span>Gaming!!</h3>
                                    <p className="banner-one__tag-line">are you ready?</p>
                                    <a href="#" className="thm-btn banner-one__btn">Let's start!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    {/* <div className="banner-one__slide banner-one__slide-two">
                        <div className="container">
                            ...
                            <div className="row no-gutters">
                                <div className="col-xl-12">
                                    <h3 className="banner-one__title banner-one__light-color">Welcome <br />
                                        To <span style={{color:"#2da397"}}>OXGaming!!</span></h3>
                                    <p className="banner-one__tag-line">are you ready?</p>
                                    <a href="#" className="thm-btn banner-one__btn">Let's start!</a>
                                </div>
                            </div>
